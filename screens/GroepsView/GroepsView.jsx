...
import { colorDarkGreen, colorDarkGrey,  colorGreen, colorLightGreen, colorLightGrey, colorOrange, colorWhite, colorYello } from '../../constants/Colors'
...
const ChatHeader = ({item}) => {
    ...
    return(
        <View >
            ...
            <View style={{backgroundColor:colorDarkGreen, padding:4,}}>
