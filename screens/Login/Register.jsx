    ...
    return (
        <View style={styles.container}>
            ...
            <Button  
                ...
                titleStyle={{color:colorGreen}} onPress={() => navigation.navigate('Tabs')}/>
            <View style={{display:'flex', flexDirection:'row', borderTopWidth: 1,borderTopColor: colorblue, width:"94%", paddingVertical:30, marginTop:30}}>
