...
const ChatviewUser = ({person,renderItem,renderSeparator,text,selectedId,filterArray,changeView,actionSheetRef,navigation, pickFromCamera}) => {

    return (
        <View style={styles.container}>
          <HeaderAnimated filterArray={filterArray} 
